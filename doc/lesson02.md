...
- 3: изменить `MealRepository/InMemoryMealRepositoryImpl`: в одном общем хранилище хранится вся еда всех пользователей. Любо пользователь авторизуется видит/модифицирует только свою еду
